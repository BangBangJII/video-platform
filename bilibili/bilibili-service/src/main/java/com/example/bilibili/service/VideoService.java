...
//    private ContentService contentService;
    ...
    public void addVideos(Video video) {
        ...
        if (tagList != null && !tagList.isEmpty()) {
            ...
            System.out.println("Video has no tags, skipping batchAddVideoTags.");
        }
    }
    ...
    public Map<String, Object> getVideoDetails(Long videoId) {
        ...
        String rawUrl = video.getUrl(); // 保存原始路径
        video.setUrl(fastdfsUrl + rawUrl); // 设置前端展示用的完整 URL
        video.setUrl(fastdfsUrl + rawUrl); // 重新设定播放 URL
        video.setRawUrl(rawUrl); // 设置原始文件路径，确保前端访问FastDFS streaming时传递正确的相对路径
        ...
        System.out.println("拼接后的视频URL是：" + video.getUrl());
        return result;
    }
    ...
    public List<VideoBinaryPicture> convertVideoToImage(Long videoId, String fileMd5) throws Exception{
        ...
        String filePath = "/Users/your_user_name/tmpfile/fileForVideoId" + videoId + "." + file.getType();
